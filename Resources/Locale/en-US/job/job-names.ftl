...
job-name-senior-physician = Surgeon
job-name-senior-officer = Mech Jockey
...
job-name-cburn = High Command Liquidation Officer
job-name-deathsquad = High Command Agent
...
JobCentralCommandOfficial = High Command Official
